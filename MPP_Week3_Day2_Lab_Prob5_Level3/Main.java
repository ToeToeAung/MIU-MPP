...
public class Main {
	...
	public static void main(String[] args) throws IOException {
				 ...
				 Faculty faculty1= new Faculty("Frank Moore", "472-5921", 43,10000);
		         ...
		         while(true)
		            ...
		            switch(choice)
		               ...
		               case 'g':
		                  ...
		                  System.out.println("-----------------------------------\n");		
		                  putText("Total salary with Streams :");
		                  totalSalary= dept.getTotalSalaryWithStreams();
		                 // putText(String.valueOf(totsalary)+"\n");   
		                  System.out.printf("$%,.2f\n", totalSalary);
		                  
							/*
							 * System.out.println("-----------------------------------\n");
							 * putText("Total salary with Polymorphism is :"); totalSalary=
							 * dept.getTotalSalaryWithPolymorphism(); //
							 * putText(String.valueOf(totsalary)+"\n"); System.out.printf("$%,.2f\n",
							 * totalSalary);
							 */
		                  ...
		                  break;
		               case 's':
		            	   System.out.println("Show All Members using Streams :");
		                  dept.showAllMembersWithStreams();
		            	 // dept.showAllMembers();
		                  break;
		               case 'u':
		                 // dept.unitsPerFaculty();
		            	   ...
		            	   System.out.println("-----------------------------------\n");	
			                  ...
			                  putText("Units Per Faculty using Streams :");
			                  dept.unitsPerFacultyWithStreams(courses);			                 
								/*
